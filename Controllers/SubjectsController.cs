...
namespace SchoolApplicationCrud.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Sub_Id,Sub_Name")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Sub_Id,Sub_Name")] Subject subject)
        {
        ...
        {
          return (_context.Subject?.Any(e => e.Sub_Id == id)).GetValueOrDefault();
        }
    }
}
